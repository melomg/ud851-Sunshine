...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        textViewDescription = (TextView) findViewById(R.id.tv_weather_description);
        textViewHigh = (TextView) findViewById(R.id.tv_high_temperature);
        textViewLow = (TextView) findViewById(R.id.tv_low_temperature);
